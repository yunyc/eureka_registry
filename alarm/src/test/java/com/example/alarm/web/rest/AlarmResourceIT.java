...
import com.example.alarm.service.dto.AlarmDTO;
import com.example.alarm.service.mapper.AlarmMapper;
...
class AlarmResourceIT {
    ...
    public static Alarm createEntity(EntityManager em) {
        Alarm alarm = new Alarm()
            ...
            .musicTitle(DEFAULT_MUSIC_TITLE)
            .musicPath(DEFAULT_MUSIC_PATH)
            .vbEnabled(DEFAULT_VB_ENABLED)
            .useSwitch(DEFAULT_USE_SWITCH)
    ...
    void createAlarm() throws Exception {
        ...
        assertThat(testAlarm.getMusicTitle()).isEqualTo(DEFAULT_MUSIC_TITLE);
        assertThat(testAlarm.getMusicPath()).isEqualTo(DEFAULT_MUSIC_PATH);
        assertThat(testAlarm.getVbEnabled()).isEqualTo(DEFAULT_VB_ENABLED);
        assertThat(testAlarm.getUseSwitch()).isEqualTo(DEFAULT_USE_SWITCH);
    ...
    void putExistingAlarm() throws Exception {
        ...
        assertThat(testAlarm.getMusicTitle()).isEqualTo(UPDATED_MUSIC_TITLE);
        assertThat(testAlarm.getMusicPath()).isEqualTo(UPDATED_MUSIC_PATH);
        assertThat(testAlarm.getVbEnabled()).isEqualTo(UPDATED_VB_ENABLED);
        assertThat(testAlarm.getUseSwitch()).isEqualTo(UPDATED_USE_SWITCH);
