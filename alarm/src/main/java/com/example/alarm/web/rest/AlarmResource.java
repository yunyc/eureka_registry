...
public class AlarmResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of alarms in body.
     */
    @GetMapping("/alarms-by-userId")
    public ResponseEntity<List<AlarmDTO>> getAllAlarmsByUserId(@org.springdoc.api.annotations.ParameterObject Pageable pageable,
    ...
    public ResponseEntity<Void> deleteAlarm(@PathVariable Long id) throws ExecutionException, InterruptedException, JsonProcessingException {
