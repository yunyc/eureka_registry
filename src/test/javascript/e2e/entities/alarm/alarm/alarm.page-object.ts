...
export default class AlarmComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('alarm-heading'));
...
export class AlarmDeleteDialog {
  ...
  title: ElementFinder = element(by.id('gatewayApp.alarmAlarm.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-alarm'));
}
