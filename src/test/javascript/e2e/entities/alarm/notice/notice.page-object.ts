...
export default class NoticeComponentsPage extends AlertPage {
...
export class NoticeDeleteDialog {
  ...
  title: ElementFinder = element(by.id('gatewayApp.alarmNotice.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-notice'));
}
