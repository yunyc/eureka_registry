...
export default class KeywordComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('keyword-heading'));
...
export class KeywordDeleteDialog {
  ...
  title: ElementFinder = element(by.id('gatewayApp.alarmKeyword.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-keyword'));
}
