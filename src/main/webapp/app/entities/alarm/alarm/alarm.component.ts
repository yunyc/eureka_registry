...
export default class Alarm extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IAlarm): void {
  ...
  public removeAlarm(): void {
    this.alarmService()
      ...
      .then(() => {
        const message = this.$t('alarmApp.alarmAlarm.deleted', { param: this.removeId });
