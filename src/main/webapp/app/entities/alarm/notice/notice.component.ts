...
export default class Notice extends mixins(JhiDataUtils) {
  ...
  public retrieveAllNotices(): void {
  ...
  public prepareRemove(instance: INotice): void {
  ...
  public removeNotice(): void {
    this.noticeService()
      ...
      .then(() => {
        const message = this.$t('alarmApp.alarmNotice.deleted', { param: this.removeId });
